...
namespace Furion.Extras.DatabaseAccessor.FreeSql.Repositories
{
    ...
    public partial class MultiFreeSql<TDBKey> : BaseDbProvider, IFreeSql
    {
        ...
        internal AsyncLocal<TDBKey> _dbkeyCurrent = new();
    ...
    public static class MultiFreeSqlExtensions
    {
        ...
        {
            if (fsql is not MultiFreeSql<TDBKey> multiFsql) throw new Exception("fsql 类型不是 MultiFreeSql<TDBKey>");
